namespace MyDevTools
{
    ...
    public partial class MyDevToolsForm
    {
        ...
        private void BtnDsbBuildFrontSolutionClick(object sender, EventArgs e)
        {
            if (!CheckIfCanRunProcess("Unable to run process!\r\nAnother process is already running."))
            {
                return;
            }
            _workerThread = new Thread(RunDsbFrontBuildSolution);
            _workerThread.Start();
        }
        ...
        void RunDsbBuildSolution()
        {
            ...
            {
                message = $"Success of Building solution 'Back' {solutionFile}";
            }
            else
            {
                message = $"Error when Building solution 'Back' {solutionFile}\r\n{errors}";
            }
            Invoke((MethodInvoker)(() =>
            {
                DashboardProcess(true);
        ...
        void RunDsbFrontBuildSolution()
        {
            ...
            string errors = string.Empty;
            if (GenericHelper.InvokeYarn(solutionFileFullPath, ref errors))
            {
                message = $"Success of Building solution 'Front' {solutionFile}";
            }
            else
            {
                message = $"Error when Building solution 'Front' {solutionFile}\r\n{errors}";
            }
            Invoke((MethodInvoker)(() =>
            {
                DashboardProcess(true);
        ...
        void RunDsbNugetRestore()
        {
            ...
            if (GenericHelper.RunCommandLine(new List<string>
                ...
                }, string.Empty, ref errorMessages))
            {
        ...
        void RunDsbRebuildSolution()
        {
            ...
            {
                message = $"Success of Rebuilding solution 'Back' {solutionFile}";
            }
            else
            {
                message = $"Error when Rebuilding solution 'Back' {solutionFile}\r\n{errors}";
            }
            Invoke((MethodInvoker)(() =>
            {
                DashboardProcess(true);
        ...
        void RunPreBuild()
        {
            ...
            string errorMessages = string.Empty;
            if (GenericHelper.RunCommandLine(PreBuildFiles.ToList(), string.Empty, ref errorMessages))
            {
        ...
        void RunPostBuild()
        {
            ...
            string errorMessages = string.Empty;
            if (GenericHelper.RunCommandLine(PostBuildFiles.ToList(), string.Empty,ref errorMessages))
            {
