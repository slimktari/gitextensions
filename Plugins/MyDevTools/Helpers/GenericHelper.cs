namespace MyDevTools.Helpers
{
    ...
    public class GenericHelper
    {
        ...
        public static bool InvokeMsBuild(string solutionFileFullPath, Generic.GenrateSolutionArguments argument, ref string errors)
        {
            ...
            RunCommandLine(msBuildFile, arguments, string.Empty, ref errors);
        ...
        public static bool RunCommandLine(List<string> commands, string workingDirectory, ref string errorMessages)
        {
        ...
        public static bool RunCommandLine(string fileName, string arguments, string workingDirectory, ref string errorMessages)
        {
            string output;
